...
public class Validate {
    ...
    protected static int diagonalCheck() {
        int count = 0;
        int count2 = 0;
    ...
    protected static int horizontalCheck() {
        int x = 0;
        int y = 0;
    ...
    protected static int verticalCheck() {
        int x = 0;
        int y = 0;
        for (int i = 0; i < arr.length; i++) {
            for (int j = 0; j < arr.length; j++) {
    ...
    protected static int checkDraw() {
        int count = 0;
        for (int i = 0; i < arr.length; i++) {
            for (int j = 0; j < arr.length; j++) {
                if (arr[i][j] == ' ')
    ...
    protected static void createGrid(int dim) {
